...
def generate_p_list(args):
    # data_type,input_dimension,l_centers = 'smap',25,['E-8','T-3'] #['D-6']#['E-8','T-3','D-4','E-11','D-11'] smap dataset
    # data_type,input_dimension,l_centers = 'msl',25,['P-10']#['M-5','M-4','F-8']#['M-5','M-4','P-10','F-8'] # msl dataset
    data_type,input_dimension,l_centers = 'yahoo',1, ['29','50','25']#['18','60']#['60','29','50','25']#['18']# yahoo dataset
    l_cma_files =  ['bestby_lossf']#['bestby_lossf','compensate_inputs']#
    l_archs = ['pre_adjw']#['best','pre_adjw']
    l_sets  = ['trainset']#['adj_w','testset']
                    ...
                    for cma_file in l_cma_files:
                        ...
                        for w_size,filter,loss_f in zip(l_inputs,l_filter,l_loss_f):
                            ...
                            for exp in l_exp:
                                ...
                                if arch_type == 'pre_adjw':
                                    cma_path = '{}/{}/cma'.format(exp_path,arch_type)
                                else:
