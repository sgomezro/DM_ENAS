...
def generate_p_list(args):
    # data_type,l_centers = 'smap',['D-6']#['E-8','T-3','D-6','E-11','D-11'] smap dataset
    data_type,l_centers = 'msl',['D-16'] #['M-5','M-4','P-10','F-8'] msl dataset
    # data_type,l_centers = 'yahoo', ['18','60','29','50','25']# yahoo dataset
    l_cma_files = ['bestby_lossf']#['bestby_lossf','compensate_inputs']
    
    l_exp    = [1,2,3]
    l_gen    = ['0100']#[str(i).zfill(4) for i in range(1,10,1)]+[str(i).zfill(4) for i in range(10,301,10)]
