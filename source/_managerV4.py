        ...
        while True:
            ...
            if parents != None:
                ...
                for i in range(1,p['n_workers']):
                    children.extend(gather_children[i])
...
def cae_worker(dtype=double):
    ...
    while True:
        ...
        if step == 'new_dataset':
            ...
            gather_children = comm.gather(sub_children,root=0)
            ...
            gather_fitness = comm.gather(sub_fitness.numpy(),root=0)
