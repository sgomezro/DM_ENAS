...
class metric_class():
    ...
    def get_multi_score_report(self,score_get):
        ...
        '''
        report = classification_report(self.cat_target,self.cat_predict,target_names=self.labels,output_dict=True,zero_division=0)
        if score_get == 'full':
            ...
            col = ['ROC_micro','ROC_macro','AP_micro','AP_macro',
                   'accuracy','micro','macro precision', 'macro recall','macro f1-score']
